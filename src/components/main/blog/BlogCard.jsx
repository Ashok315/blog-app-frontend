  ...
  return (
    <>
       <div className='card rounded-lg bg-white max-w-[17.8rem] p-[0.7rem] shadow-md'>
            ...
            <img src={blogImage} alt="blog-image" className='bg-gray-300 w-[18rem] h-[10.3rem] rounded-md object-cover cursor-pointer' onClick={()=>navigate(`/blog/${slug}`)} />
            ...
            <div className='flex items-center justify-between gap-2 rounded-md mt-4 px-2'>
              <div className='flex gap-2 items-center'>
                  <img src={authorImage} alt="profile-image" className='w-[30px] h-[30px] max-w-[35px] max-h-[35px] rounded-full object-cover' />   
