                         ...
                         <div key={item._id} className='flex gap-2 mt-[1.1rem]'>
                              ...
                              <div>
                                 <div className="flex gap-2 items-center text-xs">
                                    <p className='capitalize font-semibold text-gray-700 dark:text-gray-300'>{item.commentedBy.firstName+" "+item.commentedBy.lastName}</p>
                                    <p className='text-gray-600 dark:text-gray-200'><span className='pr-1.5 font-semibold'>&#x2022;</span>{formatDate(item.commentedBy.createdAt)}</p>
                                 </div>
